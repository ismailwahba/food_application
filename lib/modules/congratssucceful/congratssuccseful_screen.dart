...
class CongratsSuccseful extends StatefulWidget {
  const CongratsSuccseful({super.key});

  @override
  State<CongratsSuccseful> createState() => _CongratsSuccsefulState();
}

class _CongratsSuccsefulState extends State<CongratsSuccseful> {
  // var gradient;
